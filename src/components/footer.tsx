                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><Link href="#" className="hover:text-primary">Air Freight</Link></li>
                            <li><Link href="#" className="hover:text-primary">Ocean Freight</Link></li>
                            <li><Link href="#" className="hover:text-primary">Ground Shipping</Link></li>
                            <li><Link href="#" className="hover:text-primary">Warehousing</Link></li>
                        </ul>
                    </div>
